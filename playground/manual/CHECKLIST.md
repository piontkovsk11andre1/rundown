...
Use this as a client-facing acceptance checklist for `rundown`.
...
- [ ] Run `rundown run tasks/02-nested.md --worker opencode run`
...
- [ ] Run `rundown run tasks/03-verify-repair.md --only-verify --worker opencode run`
...
- [ ] Run `rundown run tasks/03-verify-repair.md --only-verify --retries 1 --worker opencode run`
...
- [ ] Run `rundown run tasks/05-inline-cli.md --no-verify`
...
- [ ] Run `rundown run tasks/05-inline-cli.md --worker opencode run`
- [ ] Confirm the inline task executes and then verifies successfully

## 7. Planner flow

- [ ] Run `rundown plan tasks/04-plan.md --worker opencode run`
...
- [ ] Run `rundown init`
- [ ] Confirm `.rundown/execute.md`, `.rundown/verify.md`, `.rundown/repair.md`, `.rundown/plan.md`, and `.rundown/vars.json` were created
